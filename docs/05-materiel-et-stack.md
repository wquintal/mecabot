...
> 2. **Le chiffre de tampon est publié, contrairement à ce qui est écrit ici :** `[VÉRIFIÉ]` **4 ko de taille de message** pour l'OBDLink EX, contre 2 ko pour un SX ou un STN1110. La fourchette de **300-500 trames/s**, elle, reste bien `[COMMUNAUTÉ]` — le manuel ne publie pas de débit utile. Le bloc G de `13` la mesure sans la promouvoir.
