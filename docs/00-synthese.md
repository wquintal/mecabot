...
| **`13-protocole-seance-terminal.md`** | **La séance au terminal série, exécutable** : ce que le manuel du fabricant a déjà levé (et les deux affirmations du dossier qu'il contredit), les huit blocs de commandes dans l'ordre, la fiche de relevé, le format de trace que le rejeu consommera, et l'anonymisation obligatoire avant tout versement |
