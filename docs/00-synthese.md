...
> - **Il n'y a pas de porte de relecture humaine sur le diff.** Elle est remplacée par quatre relecteurs — Gemini, CodeRabbit, Claude, `cargo-deny` — et cette substitution n'est valide que tant qu'ils tournent réellement (`12` §6.3).
