...
| **Relecture du diff** | **Flotte de quatre relecteurs, pas de porte humaine** | Gemini, CodeRabbit, Claude, `cargo-deny`. ⛔ Règle valide **tant que la flotte tourne** : trois relecteurs de code indépendants au minimum. Décidé le 2026-08-26, voir `12` §6.3. |
